        ...
        if key == 27: # ==> escape
            ...
            for box in number_imgs:
                ...
                if 48 <= key <= 57:
                    ...
                    cv2.imwrite(f'data/printed_digits/image_{count_number}_{number}.png', box)
...
create_dataset(folder_path='data/new_sudokus/', images_folder_path='data/trained_sudokus/')
